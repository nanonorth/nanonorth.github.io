...
function GraphicalChart({ equation, XL, XR, rootResult }) {
  ...
  // สร้าง graph ของฟังก์ชันจาก XL ถึง XR
  const generateFunctionData = () => {
    const data = [];
    const range = Math.abs(xrValue - xlValue);
    
    // กำหนดจำนวนจุดตามความกว้างของช่วง
    let numPoints = 500;
