...
import BisectionGraph from "./Chart/Bisection_Chart";
    ...
    >
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <p style={{ color: "#A0A0A0", marginBottom: "30px", fontSize: "1.1rem" }}>
          วิธีแบ่งครึ่งช่วงสำหรับหารากของสมการ
        </p>
        ...
        {iterations.length > 0 && (
          ...
          >
            ...
            >
              {iterations[iterations.length - 1].xm.toFixed(6)}
            </div>
            <div
              style={{
                marginTop: "10px",
